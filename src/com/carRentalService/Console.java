...
public class Console {
    ...
    static void readRentCarSelection(ArrayList<String> availableCarsArr) {
        while(true) {
...
//            System.out.println(Console.readConfirmation(Console.selectedCarByte, availableCarsArr)); //true: user is sure. false: user is not sure
    ...
    static boolean readConfirmation(Byte selectedCarByte, ArrayList<String> availableCarsArr) {
        while(true) {
            System.out.print("Are you sure you would like to rent the "+availableCarsArr.get(selectedCarByte-1)+"? ");
            Scanner scanner = new Scanner(System.in);
            try{
